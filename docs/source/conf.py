...
latex_documents = [
    (master_doc, 'lesionqc.tex', 'lesionqc Documentation',
...
man_pages = [
    (master_doc, 'lesionqc', 'lesionqc Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'lesionqc', 'lesionqc Documentation',
     author, 'lesionqc', 'One line description of project.',
     'Miscellaneous'),
]
